...
Regardless of outcome (tailored, skipped, failed, or duplicate), append one line to `~/resume-agent/processed-listings.log`:
...
After a successful build (TAILORED only — not SKIPPED, FAILED, or DUPLICATE), create a new page in the Notion Job Applications database using `mcp__claude_ai_Notion__notion-create-pages`:
...
──────────────────────────────────────────────────────────────
 ...
 ...
──────────────────────────────────────────────────────────────
Resumes generated: X  |  Skipped: Y  |  Duplicates: D  |  In-run dupes removed: Q  |  Notion entries: N  |  Emails labeled: Z
```
