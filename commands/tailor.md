...
- Job description target: `/Users/stack3/resume-agent/job-description.md`
- Outputs folder (lives on Desktop for easy access): `/Users/stack3/Desktop/Resume Outputs/`
...
- Once you have the JD text, write it to `/Users/stack3/resume-agent/job-description.md`, overwriting the file. Wrap the content in a minimal header so the file is self-describing:
...
- If the fit agent's verdict was **No** OR the user says no/decline/stop: do NOT run the tailoring or proofread agents. Acknowledge and stop. The full analysis is in `/Users/stack3/Desktop/Resume Outputs/01-fit-analysis.md` for their reference.
...
Follow the tailoring prompt's instructions exactly. The output must mirror the master resume's structure (section names, job-block format, grouped skills). Write the tailored resume to `/Users/stack3/Desktop/Resume Outputs/02-tailored-resume.md`.
...
```
/Users/stack3/resume-agent/build/build-resume.sh
```

This extracts the **Final Resume** section from `03-final-resume-review.md` and produces:
- `/Users/stack3/Desktop/Resume Outputs/final-resume.docx`
- `/Users/stack3/Desktop/Resume Outputs/final-resume.pdf`
